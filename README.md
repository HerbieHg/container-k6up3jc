...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-k6up3jc.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-k6up3jc.containers.anotherwebservice.com/
...
```
git clone git@github.com:HerbieHg/container-k6up3jc.git
cd container-k6up3jc
```
...
```
docker attach container-k6up3jc
```
